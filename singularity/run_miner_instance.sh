...
singularity exec --env INDEX=$index instance://eth-miner-$index bash /run_miner.sh --mine --miner.threads=1 --allow-insecure-unlock --http --http.addr="0.0.0.0" --http.port="880$index" --http.api="eth,web3,net,admin,personal" --http.corsdomain="*" --netrestrict="127.0.0.1/27" --port="3033$index" &
