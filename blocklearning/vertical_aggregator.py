...
class VerticalAggregator:
    ...
    def aggregate(self):
        ...
        # outputs = [
        #     self.datastore.load(output_id) for (_, _, _, output_id) in submissions
        # ]
        ...
        #     zip(server_grads, self.model.model.trainable_weights)
        # )
        ...
        # self.contract.submit_aggregation_with_gradients(
        #     weights_id, trainers, client_grads_ids
        # )
        ...
        #                 "submissions": submissions,
        #                 "ts": time.time_ns(),
        #                 "new_weights": weights_id,
        #                 "client_grads": client_grads_ids,
        #                 "accuracy": float_to_int(accuracy),
        #             }
        #         )
        #     )
