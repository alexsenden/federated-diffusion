...
class Scorer:
    ...
    def score(self):
        (round, submissions_trainers, submissions) = (
            self.contract.get_submissions_for_scoring()
        )
        ...
        scores_trainers, scores = self.scorer.score(
            round, submissions_trainers, submissions
        )
                ...
                json.dumps(
                    {
                        ...
                        "submissions": submissions,
                        "ts": time.time_ns(),
                        "submissions_trainers": submissions_trainers,
                        "scores": scores,
                    }
                )
            )
